...
This is a small repo with a focused scope: 6 research-team agents, 13 slash commands, 18 skills, 4 lightweight hooks, and field-specific example presets. Contributions that fit that scope are welcome. Contributions that expand it (npm publishing, build pipelines, domain-specific helpers in the core, etc.) probably belong in upstream [`oh-my-claudecode`](https://github.com/Yeachan-Heo/oh-my-claudecode) instead.
